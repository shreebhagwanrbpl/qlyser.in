...
export default function ServiceCard({
  ...
  return (
    <div className="group relative overflow-hidden rounded-[30px] border border-[#CBD5E1]/15 bg-white p-8 shadow-[0_15px_50px_rgba(15,23,42,.08)] transition-all duration-500 hover:-translate-y-3 hover:border-[#94A3B8]/40 hover:shadow-[0_25px_70px_rgba(15,23,42,.15)]">
      ...
      <div className="mt-8 flex items-center gap-2 font-semibold text-[#64748B] opacity-0 transition-all duration-300 group-hover:translate-x-2 group-hover:opacity-100">

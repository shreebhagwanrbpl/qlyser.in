  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-white">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute -top-40 left-1/2 -translate-x-1/2 h-[500px] w-[500px] rounded-full bg-[#E2E8F0]/40 blur-[120px]" />
      ...
      <div className="relative z-10 container-custom min-h-screen flex items-center justify-center py-24">
        ...
        >
          ...
          <div className="inline-flex items-center gap-3 rounded-full border border-yellow-200 bg-white px-5 py-2 shadow-[0_20px_50px_rgba(15,23,42,.12)]">
            ...
            {loading ? (
              ...
              <>
                ...
                {city && (
                  ...
                  <span className="block mt-4 text-2xl md:text-3xl font-semibold text-[#1E293B]">
            ...
            {loading ? (
              ...
              <>
                <Link href={makeLink("/services")}>
                  ...
                  <button className="group flex h-14 items-center gap-3 rounded-2xl bg-gradient-to-r from-[#64748B] to-[#CBD5E1] px-8 font-semibold text-white shadow-xl transition hover:scale-105">
                ...
                <Link href={makeLink("/contact")}>
                  ...
                  <button className="h-14 rounded-2xl border border-yellow-300 bg-white px-8 font-semibold text-slate-700 transition hover:border-yellow-400 hover:bg-yellow-50">
          ...
          <div className="mt-20 grid grid-cols-2 gap-6 md:grid-cols-4">
            ...
            {[
              ...
              <div
                key={label}
                className="rounded-3xl border border-slate-200 bg-white/80 p-6 backdrop-blur-lg shadow-[0_20px_50px_rgba(15,23,42,.12)]"
              >

                <h3 className="text-4xl font-black text-[#1E293B]">

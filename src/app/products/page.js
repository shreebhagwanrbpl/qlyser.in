      ...
      <section className="py-24 bg-slate-50">
        ...
        <div className="max-w-7xl mx-auto px-5">
          ...
          ====================== */}
            ...
            <aside className="sticky top-28 h-fit overflow-hidden rounded-[32px] border border-[#CBD5E1]/20 bg-white shadow-[0_25px_70px_rgba(15,23,42,.08)]">
              ...
              <div className="border-b border-[#CBD5E1]/15 bg-white p-6">
                ...
                <div className="relative mt-6">
                  ...
                  <input
                    ...
                    className="h-14 w-full rounded-2xl border border-[#CBD5E1]/15 bg-white px-5 pr-12 outline-none transition focus:border-[#94A3B8] focus:ring-4 focus:ring-[#CBD5E1]/20"
                  />
              ...
              <div className="max-h-[70vh] overflow-y-auto p-5 custom-scrollbar space-y-4">
                ...
                {categories.map((category) => (
                  ...
                  <div
                    key={category}
                    className="overflow-hidden rounded-2xl border border-[#CBD5E1]/15 bg-white"
                  >
                    ...
                    >
                      ...
                      {groupedProducts[category].map((item) => (
                        ...
                        <button
                          ...
                          className="block w-full border-t border-[#CBD5E1]/10 px-6 py-3 text-left text-sm text-slate-600 transition hover:bg-white hover:text-[#64748B]"
                        >
                        ...
                        {list.map((product) => (
                          ...
                          >
                            ...
                            <div className="grid items-center gap-8 lg:grid-cols-[260px_1fr_200px]">
                              ...
                              <div className="group relative flex h-[230px] items-center justify-center overflow-hidden rounded-[28px] border border-[#CBD5E1]/15 bg-white">

                                <div className="absolute -right-10 -top-10 h-32 w-32 rounded-full bg-[#CBD5E1]/10 blur-3xl" />
                              ...
                              <div>
                                ...
                                <span className="inline-flex items-center rounded-full bg-[#F8FAFC] px-4 py-2 text-xs font-semibold uppercase tracking-wider text-[#64748B]">
                                ...
                                <div className="mt-8 grid grid-cols-2 gap-4">
                                  ...
                                  <div className="rounded-2xl border border-[#CBD5E1]/15 bg-white p-4">
                              ...
                              <div className="flex justify-center lg:justify-end">
                                ...
                                >
                                  ...
                                  <button className="w-full rounded-2xl bg-gradient-to-r from-[#64748B] via-[#94A3B8] to-[#CBD5E1] px-8 py-4 font-semibold text-white shadow-[0_15px_40px_rgba(212,175,55,.35)] transition-all duration-300 hover:scale-105 hover:shadow-[0_20px_50px_rgba(212,175,55,.45)] lg:w-auto">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-5">
          ...
          <div className="mt-20 grid gap-8 md:grid-cols-2 xl:grid-cols-4">
            ...
            {[
              ...
              <div
                key={index}
                className="group relative overflow-hidden rounded-[32px] border border-[#CBD5E1]/15 bg-white p-8 text-center shadow-[0_20px_60px_rgba(15,23,42,.08)] transition-all duration-500 hover:-translate-y-3 hover:border-[#94A3B8]/40 hover:shadow-[0_30px_80px_rgba(15,23,42,.15)]"
              >

                {/* Gold Glow */}

                <div className="absolute -right-10 -top-10 h-32 w-32 rounded-full bg-[#CBD5E1]/10 blur-3xl opacity-0 transition duration-500 group-hover:opacity-100" />
                ...
                <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-3xl bg-[#F8FAFC] text-[#64748B] shadow-lg shadow-yellow-200/40 transition duration-500 group-hover:scale-110 group-hover:rotate-6">
                ...
                <div className="mx-auto mt-5 h-1 w-16 rounded-full bg-gradient-to-r from-[#64748B] to-[#CBD5E1] transition-all duration-500 group-hover:w-24" />

  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-white py-24">
        ...
        <div className="absolute -top-40 left-1/2 h-[520px] w-[520px] -translate-x-1/2 rounded-full bg-[#CBD5E1]/10 blur-[150px]" />

        <div className="absolute bottom-0 left-0 h-[280px] w-[280px] rounded-full bg-[#E2E8F0]/15 blur-[120px]" />
          ...
          <div className="mt-20 grid gap-8 md:grid-cols-2 xl:grid-cols-3">
            ...
            {loading
              ? Array.from({ length: 6 }).map((_, index) => (
                ...
                <div
                  key={index}
                  className="rounded-[32px] border border-[#CBD5E1]/15 bg-white p-8 shadow-[0_20px_60px_rgba(15,23,42,.08)] animate-pulse"
                >

                  <div className="mb-8 h-20 w-20 rounded-3xl bg-[#F8FAFC]" />
      ...
      <section className="relative overflow-hidden bg-white py-24">
        ...
        <div className="absolute -top-40 left-1/2 h-[500px] w-[500px] -translate-x-1/2 rounded-full bg-[#CBD5E1]/10 blur-[150px]" />
        ...
        <div className="relative z-10 container-custom">
          ...
          <div className="mt-20 grid gap-8 lg:grid-cols-3">
            ...
            {[
              ...
              <div
                key={index}
                className="group relative overflow-hidden rounded-[32px] border border-[#CBD5E1]/15 bg-white p-8 shadow-[0_20px_60px_rgba(15,23,42,.08)] transition-all duration-500 hover:-translate-y-3 hover:border-[#94A3B8]/40 hover:shadow-[0_30px_80px_rgba(15,23,42,.15)]"
              >
                ...
                <span className="absolute right-6 top-4 text-7xl font-black text-[#CBD5E1]/15">
                ...
                <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-[#64748B] via-[#94A3B8] to-[#CBD5E1] text-xl font-bold text-white shadow-lg shadow-yellow-200/40 transition duration-500 group-hover:scale-110">
                ...
                <h3 className="mt-8 text-2xl font-bold text-[#1E293B] transition-colors duration-300 group-hover:text-[#64748B]">
